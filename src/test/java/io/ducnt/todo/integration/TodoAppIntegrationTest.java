...
public class TodoAppIntegrationTest {
    ...
    void testTodoTypeReadThroughAllLayers() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/todoType/PERSONAL")
                        .contentType("application/json"))
                .andReturn();
    ...
    void testTodoTypeUpdateThroughAllLayers() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/todoType")
                        .contentType("application/json")
                        .content(objectMapper.writeValueAsString(personal)))
                .andExpect(status().isOk());
    ...
    void testTodoTypeDeleteThroughAllLayers() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/todoType/PERSONAL")
                        .contentType("application/json"))
                .andExpect(status().isOk());
    }
}
