package io.ducnt.todo.utils.aop;
...
public class LoggingAspect {
    ...
    @Before("@annotation(io.ducnt.todo.utils.aop.LogMethodDetails)")
    public void logMethodCall(JoinPoint jp) throws Throwable {
        logger.info(jp.getSignature() + " is called");
    }

    @Around("@annotation(io.ducnt.todo.utils.aop.LogMethodDetails)")
    ...
    @AfterThrowing(value = "@annotation(io.ducnt.todo.utils.aop.LogMethodDetails)", throwing = "ex")
